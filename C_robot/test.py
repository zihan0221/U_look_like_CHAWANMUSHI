...
class Game:
    ...
    def tileBackground(self, file) -> None:
        screenWidth, screenHeight = Game.SIZE
        ...
        for x in range(tilesX):
            for y in range(tilesY):
                self.screen.blit(file, (x * imageWidth, y * imageHeight))
class Tileset:
...
tilemap.render()
bg = pygame.image.load('./img/wall.png')
print(type(bg))
game = Game()
game.run()
